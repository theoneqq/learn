...
00000000004010f4 <phase_6>:
  ...
  40111e:	83 f8 05             	cmp    $0x5,%eax // number <= 5
  401121:	76 05                	jbe    401128 <phase_6+0x34>
  401123:	e8 12 03 00 00       	callq  40143a <explode_bomb>
  401128:	41 83 c4 01          	add    $0x1,%r12d
  40112c:	41 83 fc 06          	cmp    $0x6,%r12d //loop?
  401130:	74 21                	je     401153 <phase_6+0x5f>
  401132:	44 89 e3             	mov    %r12d,%ebx
  401135:	48 63 c3             	movslq %ebx,%rax // move with sign from long(32) to quad(64)
  ...
  40114b:	7e e8                	jle    401135 <phase_6+0x41> // different six number and  <= 5
  ...
  40116d:	75 f1                	jne    401160 <phase_6+0x6c> // every number reset to 7 - number
  ...
  4011a9:	eb cb                	jmp    401176 <phase_6+0x82> // copy struct pointer
  ...
  4011d2:	48 c7 42 08 00 00 00 	movq   $0x0,0x8(%rdx) // reset next pointer
  4011d9:	00 
  ...
  4011f2:	83 ed 01             	sub    $0x1,%ebp // confirm sort
  4011f5:	75 e8                	jne    4011df <phase_6+0xeb> // not equal zero then jmp
